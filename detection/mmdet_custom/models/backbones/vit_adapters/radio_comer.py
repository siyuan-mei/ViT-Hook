...
from mmseg.models.backbones.adapters.comer_modules import CNN, CTIBlock, deform_inputs
from mmseg.models.backbones.vit_hooks.model_loader import RadioWrapper


@MODELS.register_module()
class RadioCoMer(RadioWrapper):
    def __init__(
        self,
        ...
        self.interactions = nn.Sequential(
            *[
                CTIBlock(
                    ...
                    use_CTI_toV=(
                        use_CTI_toV if isinstance(use_CTI_toV, bool) else use_CTI_toV[i]
                    ),
                    use_CTI_toC=(
                        use_CTI_toC if isinstance(use_CTI_toC, bool) else use_CTI_toC[i]
                    ),
