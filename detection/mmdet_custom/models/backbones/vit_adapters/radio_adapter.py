...
from mmseg.models.backbones.adapters.adapter_modules import (
    SpatialPriorModule,
    deform_inputs,
    InteractionBlock,
)

# from mmseg.models.backbones.adapters.adapter_modules import InteractionBlockWithCls as InteractionBlock
from mmseg.models.backbones.vit_hooks.model_loader import RadioWrapper


@MODELS.register_module()
class RadioAdapter(RadioWrapper):
    def __init__(
        self,
