_base_ = "..common/ssj_scp_270k_coco-instance.py"

custom_imports = dict(
    imports=["mmdet_custom.models.detectors.codetr.codetr"], allow_failed_imports=False
)
...
max_epochs = 12
train_cfg = dict(
    _delete_=True, type="EpochBasedTrainLoop", max_epochs=max_epochs, val_interval=1
)
