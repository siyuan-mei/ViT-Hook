...
def uwmadison_classes():
    """UwMadison class names for external use."""
    return ["background", "Stomach", "Small bowel", "Large bowel"]


def uwmadison_palette():
    """UwMadison palette for external use."""
...
def refuge2_palette():
    """UwMadison palette for external use."""
    return [[120, 120, 120], [6, 230, 230], [56, 59, 120]]


def cellseg_classes():
    """UwMadison class names for external use."""
    return ["background", "cell", "boundary"]
