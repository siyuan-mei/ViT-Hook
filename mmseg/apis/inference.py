...
def inference_model(
    model: BaseSegmentor, img: ImageType
...
def show_result_pyplot(
    ...
    visualizer = SegLocalVisualizer(
        vis_backends=[dict(type="LocalVisBackend")], save_dir=save_dir, alpha=opacity
    )
    visualizer.dataset_meta = dict(
        classes=model.dataset_meta["classes"], palette=model.dataset_meta["palette"]
    )
