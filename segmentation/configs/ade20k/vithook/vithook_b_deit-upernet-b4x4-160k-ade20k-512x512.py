...
num_classes = 150
pretrained = "pretrained_vit/deit_base_patch16_224-b5f2ef4d.pth"
model = dict(
    type="EncoderDecoder",
...
optim_wrapper = dict(
    ...
    optimizer=dict(
        type="AdamW", lr=1e-4, betas=(0.9, 0.999), weight_decay=0.05, eps=1e-8
    ),
    dtype="float16",
    paramwise_cfg=dict(custom_keys={"backbone.blocks": dict(lr_mult=0.1)}),
    # optimizer=dict(type="AdamW", lr=6e-5, betas=(0.9, 0.999), weight_decay=0.01, eps=1e-8),
    # dtype='float16',
